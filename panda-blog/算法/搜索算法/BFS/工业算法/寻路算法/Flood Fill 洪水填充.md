...
就是每次遇到墙体， 将受影响的点全部搜索到， 之后将这些点变成INF（极大值） ， 
之后将这些点放到队列中bfs， 每个点都检查相邻的点的值，  如果联通就更新值，不连通的就抛出队列
...
- **可使用 visited/in_queue 等机制**避免重复入队
...
这种方法的优势在于：当环境发生局部变化时，只需要更新一小部分区域，大大提高了算法的效率。
